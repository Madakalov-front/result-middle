...
import { episodeLoader } from "../../pages/episode/model";
import { locationrLoader } from "../../pages/location/model";
import { ContentOutlet } from "../../entities/content-outlet";
import { AppContentErrorBoundary } from "../../features/app-content-error-boundary";
    ...
    children: [
      {
        ...
        errorElement: <AppContentErrorBoundary />,
        children: [
          {
            index: true,
